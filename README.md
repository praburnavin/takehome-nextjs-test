...
- On selecting a nominee, the select button of remaining nominees wil be disabled for the respective category.
- Submit ballots after selecting all the nominees.
- On submitting , the success Modal will be open.
- On clicking close icon, The Modal will be closed.
